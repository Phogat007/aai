      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-lg">aai</span>
            </div>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Empowering decisions with authoritative AI. Connect with specialized assistants trained on trusted sources.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><button onClick={() => navigate("/agents")} className="hover:text-foreground transition-colors">AI Agents</button></li>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} aai. All rights reserved.
          </p>
